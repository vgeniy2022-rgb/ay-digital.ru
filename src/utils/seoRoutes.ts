...
const staticRouteLabels: Record<string, string> = {
  ...
  '/lab': 'SITEVL LAB',
  '/lab/builder': 'Конструктор сайтов',
  '/lab/2d': 'Игра Break the Website',
  '/lab/3d': 'Игра The Room',
  '/lab/physics': 'Лаборатория физики',
  '/lab/os': 'Симулятор ОС',
  '/lab/retro': 'Ретро-компьютер',
  '/lab/modern-os': 'SITEVL Modern OS',
  '/lab/canvas': 'Бесконечный холст',
  '/lab/builder-legacy': 'Классический конструктор сайтов',
  '/brief': 'Мини-бриф',
  ...
  '/website-admin-vladivostok': 'Сайт с системой управления во Владивостоке',
  '/business-website-development': 'Сайт для бизнеса',
  '/landing-development': 'Разработка лендинга',
  '/catalog-website-development': 'Сайт-каталог',
  '/online-store-development': 'Интернет-магазин',
  '/web-application-development': 'Веб-приложение',
  ...
  '/useful/how-to-order-website': 'Как заказать сайт',
  '/useful/website-or-mobile-app': 'Сайт или мобильное приложение',
  '/useful/ecommerce-development-cost': 'Стоимость интернет-магазина',
