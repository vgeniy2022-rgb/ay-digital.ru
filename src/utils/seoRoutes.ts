...
const staticRouteLabels: Record<string, string> = {
  ...
  '/lab': 'SITEVL LAB',
  '/lab/website-builder': 'Website Builder',
  '/lab/admin-demo': 'Admin Demo',
  '/lab/architecture': 'Architecture Explorer',
  '/lab/web-evolution': 'Website Evolution',
  '/lab/seo': 'SEO Visualizer',
  '/brief': 'Мини-бриф',
  '/changelog': 'Changelog',
