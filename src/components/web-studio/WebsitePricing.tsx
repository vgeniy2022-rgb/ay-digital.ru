      ...
      <div className="studio-shell">
        ...
        <div className="studio-pricing__note" data-studio-reveal>
          <div>
            ...
            <p>
              Каталог с админкой, поиском, фильтрами, документами и собственными сценариями оценивается отдельно. Цена такого проекта не является стандартной стоимостью любого сайта.
            </p>
          </div>
