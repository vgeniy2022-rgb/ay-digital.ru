...
const entries: PaletteEntry[] = [
  ...
  { id: 'builder', label: 'Собрать конфигурацию сайта', hint: 'Website Builder', keywords: 'конструктор калькулятор preview', path: '/lab/website-builder', icon: Gauge },
  { id: 'admin', label: 'Попробовать демо-админку', hint: 'Admin Demo', keywords: 'cms управление контент', path: '/lab/admin-demo', icon: Code2 },
