          ...
          <div className="rounded-premium border border-blue-100 bg-blue-50/70 p-7 shadow-glass sm:p-10">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <p className="mt-5 max-w-4xl text-base leading-8 text-muted">
                  Могу добавить на сайт политику обработки персональных данных, условия обращения, cookie-уведомление и
                  аккуратные дисклеймеры. Это помогает сделать сайт понятнее и безопаснее для работы с клиентами.
                </p>
