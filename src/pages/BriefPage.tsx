...
const questions: Array<{
  ...
  },
  {
    key: 'catalog',
    title: 'Нужен каталог?',
    description: 'Каталог влияет на структуру данных, карточки, поиск и будущую админку.',
  ...
  },
  {
    ...
    description: 'Админка нужна, когда цены, услуги, акции, фото или товары обновляются регулярно.',
    options: [{ value: 'yes', label: 'Да, нужна админка' }, { value: 'no', label: 'Редкие изменения можно передавать разработчику' }],
  },
  {
    key: 'leads',
