...
export const labExperiments: LabExperiment[] = [
  ...
  { id: 'retro', number: '06', ...labExperimentCopy.retro, status: 'INTERACTIVE', technologies: ['Canvas', 'Web Audio', 'CSS'], href: '/lab/retro', accent: '#ffd66b', difficulty: 3, duration: '25–60 мин', keyboard: true, touch: true, achievementIds: ['RETRO_USER', 'RETRO_GAMER', 'FLOPPY_SECRET', 'RETRO_MONO_USER', 'RETRO_WEB_PIONEER', 'RETRO_SECRET_FILE', 'RETRO_ARTIST', 'RETRO_DOCUMENT', 'RETRO_GAME_WINNER', 'RETRO_ALL_SYSTEMS', 'RETRO_NETWORKED', 'RETRO_SYSADMIN', 'RETRO_MAIL_USER', 'RETRO_SYSOP', 'RETRO_PROGRAMMER', 'RETRO_WEBMASTER', 'RETRO_INSTALLER'] },
  ...
  { id: 'modern-os', number: '08', ...labExperimentCopy['modern-os'], status: 'INTERACTIVE', technologies: ['React', 'Canvas 2D', 'Fullscreen API', 'LocalStorage'], href: '/lab/modern-os', accent: '#8be9ff', difficulty: 3, duration: '20–60 мин', keyboard: true, touch: true, achievementIds: ['MODERN_OS_USER', 'MODERN_MULTITASKER', 'MODERN_EXPLORER', 'MODERN_FIRST_GAME', 'MODERN_CORE_COMPLETE', 'MODERN_BLOCKS_100', 'MODERN_BEST_LAP'] },
];
