...
export function OsWindow({ windowState, onFocus, onMove, onClose, onMinimize, children }: PropsWithChildren<{ windowState: OsWindowState; onFocus: () => void; onMove: (x: number, y: number) => void; onClose: () => void; onMinimize: () => void }>) {
