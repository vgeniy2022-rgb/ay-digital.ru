...
export const routeSeo: Record<string, RouteSeo> = {
  '/': {
    ...
    description: 'Разработка сайтов и мобильных приложений для бизнеса во Владивостоке и удалённо. Прямая работа со специалистом, понятные цены и AI-концепт сайта.',
    canonicalPath: '/',
    structuredData: homeStructuredData,
  },
  '/services': {
    title: 'Разработка сайтов, приложений и IT-услуги | SITEVL',
    description: 'Услуги SITEVL во Владивостоке и удалённо: сайты для бизнеса, лендинги, каталоги, интернет-магазины, приложения и помощь с техникой.',
    canonicalPath: '/services',
  },
  '/mobile-apps': {
    title: 'Разработка мобильных приложений iOS и Android | SITEVL',
    description: 'Разработка мобильных приложений для бизнеса на iOS и Android во Владивостоке и удалённо: MVP, серверная часть, тестирование и запуск.',
    canonicalPath: '/mobile-apps',
    structuredData: serviceSchema('/mobile-apps', 'Разработка мобильных приложений', 'Мобильные приложения для iOS и Android: первая версия, бизнес-сценарии, серверная часть и интеграции.'),
  },
  '/ai-website': {
    title: 'AI-конструктор концепции сайта — SITEVL',
    description: 'Опишите бизнес и получите три безопасных варианта концепции сайта: структуру, тексты, адаптивный интерактивный прототип и оценку по действующему прайсу SITEVL.',
    canonicalPath: '/ai-website',
    structuredData: serviceSchema('/ai-website', 'AI-концепция сайта', 'Интерактивный генератор концепции сайта с проверяемой JSON-схемой, адаптивным предпросмотром и расчётом по действующему прайсу SITEVL.'),
  },
  '/prices': {
