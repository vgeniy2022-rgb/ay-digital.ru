...
export const routeSeo: Record<string, RouteSeo> = {
  ...
  '/ai-website': {
    title: 'AI-концепт сайта — инструмент SITEVL LAB',
    description: 'Лабораторный инструмент SITEVL LAB: набросок структуры, текстов и визуального направления будущего сайта с адаптивным предпросмотром. Генерация через Gemini.',
