...
const baseRoutes = [
  {
    ...
    description: 'Частный IT-специалист во Владивостоке: компьютерная помощь, настройка Windows и MacBook, перенос данных, сборка ПК, создание сайтов и удалённая помощь.',
    priority: 1,
    changefreq: 'weekly',
...
const localRoutes = [
  ...
  ['/website-development-artem', 'Создание сайтов в Артёме — лендинги, визитки и сайты с админкой', 'Создание сайтов для Артёма полностью удалённо: лендинги, сайты-визитки, сайты с админкой, адаптивный дизайн, базовая SEO-структура и связь через Telegram/WhatsApp.', 'Артём', 'Создание сайтов'],
  ['/website-development-ussuriysk', 'Создание сайтов в Уссурийске — сайты для услуг и малого бизнеса', 'Разработка сайтов для Уссурийска удалённо: сайты-визитки, лендинги, сайты с админкой, мобильная адаптация, базовая SEO-структура и контакты.', 'Уссурийск', 'Создание сайтов'],
  ['/website-development-nakhodka', 'Создание сайтов в Находке — удалённая разработка сайта под услугу', 'Создание сайта для Находки удалённо: лендинг, сайт-визитка, сайт с админкой, мобильная версия, базовое SEO и кнопки связи Telegram/WhatsApp.', 'Находка', 'Создание сайтов'],
...
const landingRoutes = [
  ...
  ['/website-development-vladivostok', 'Создание сайтов во Владивостоке — сайты для бизнеса', 'Разработка сайтов во Владивостоке для специалистов и небольшого бизнеса: лендинги, сайты-визитки, адаптация под телефон, связь и базовая SEO-подготовка.'],
