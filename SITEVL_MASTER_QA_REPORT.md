...
Исправлены 19 подтверждённых строк master audit: 3 HIGH, 10 MEDIUM и 6 LOW. Изменения ограничены локализацией, доступностью, мобильными размерами, responsive layout, fullscreen state и безопасной диагностикой. Новые продуктовые функции не добавлялись.
