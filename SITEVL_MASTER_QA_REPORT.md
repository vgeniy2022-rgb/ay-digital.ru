...
Проведён отдельный Content UX-аудит главной, услуг, цен на сайты, кейсов, брифа и локальных коммерческих посадочных страниц. Технические термины сохранены там, где они объясняют реализацию или поддерживают точный поисковый запрос; в продуктовых карточках и CTA формулировки переведены на язык задачи и результата.

| Было | Стало | Причина |
|---|---|---|
| «Сайты с админкой» | «Сайты с системой управления» | Понятно описывает продукт без внутреннего жаргона. |
| «Веб-приложения» | «Веб-сервисы для бизнеса» | Показывает назначение направления, а не только технический формат. |
| «Поддержка и развитие» | «Развитие и сопровождение» | Убирает общую формулировку и подчёркивает продолжение работы после запуска. |
| «Сайт с админкой за 20 000 ₽» | «Сайт с системой управления за 20 000 ₽» | Карточка воспринимается как законченное коммерческое предложение. |
| «Простое приложение» | «Онлайн-сервис под задачу» | Исключает оценочное слово «простое» и объясняет ценность решения. |
| «Да, нужна админка» | «Да, хочу менять контент самостоятельно» | Ответ в брифе теперь описывает реальное намерение клиента. |
| «Опишите задачу, а я подскажу самый простой следующий шаг.» | «Расскажите о задаче — предложу подходящий формат и следующий шаг.» | CTA стал конкретнее, избавился от оценочного слова «простой» и задаёт понятное ожидание от контакта. |
| «Сайт с админкой для бизнеса во Владивостоке» | «Сайт с системой управления для бизнеса во Владивостоке» | Видимый заголовок стал профессиональнее; точный запрос «сайт с админкой» сохранён в SEO title, description и естественном пояснении формата. |

Дополнительно унифицированы подписи категорий, карточек кейсов, калькулятора и цен. Для известных CMS-slug добавлен локальный presentation override, поэтому устаревшая редакция из CMS не возвращает прежние названия на публичные карточки.
